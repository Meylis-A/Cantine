...
<head>
    ...
    <link rel="stylesheet" href="{{asset('icons/icons/font-awesome/css/fontawesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('icons/icons/font-awesome/css/fontawesome.css')}}">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Cantines - Choix</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h5><span>{{$emp->matricule}}</span><br></h5>
                <h3><span>{{$emp->nom}} {{$emp->prenom}}</span><br></h3>
                <h5><span>{{$emp->societe}}</span><br></h5>
                <span>{{($emp->cadre=="1"?"Cantine 1":"Cantine 2")}}</span>
                <hr>
                <form action="{{route('cantines.affiche-date')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="row">
                        <div class="col-lg-4">
                            <input type="date" class="form-control" name="dateA" id="datepicker"
                                onchange="getValue(this.value)">
                        </div>
                        à
                        <div class="col-lg-4">
                            <input type="date" class="form-control" name="dateB" id="datepicker2"
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <button type="submit" class="btn btn-success" id="btnTerminer"
                                        style="align-content: right;">Afficher</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <form action="{{route('cantines.update-choix', $elem)}}" method="post"
                            ...
                            <tr>
                                <td>
                                    <input type="date" name="date" id="date" value="{{$elem->date}}"
                                        class="form-control">
                                </td>
                                <td>
                                    <input type="number" name="dejeuner" id="dejeuner" value="{{$elem->dejeuner}}"
                                        min="0" max="3" class="form-control">
                                </td>
                                <td>
                                    <input type="number" name="dinner" id="de" value="{{$elem->diner}}" min="0" max="3"
                                        class="form-control">
                                </td>
                                <td>
                                    <input type="number" name="collation" id="dejer" value="{{$elem->collation}}"
                                        min="0" max="3" class="form-control">
                                </td>
                                <td>
                                    <input type="number" name="yaourtj" id="deuner" value="{{$elem->yaourtj}}" min="0"
                                        max="3" class="form-control">
                                </td>
                                <td>
                                    <input type="number" name="yaourtn" id="deunr" value="{{$elem->yaourtn}}" min="0"
                                        max="3" class="form-control">
                                </td>
                                <td>
                                    <input type="number" name="cafe" id="deeuner" value="{{$elem->cafe}}" min="0"
                                        max="3" class="form-control">
                                </td>
                                <td>
                                    <input type="number" name="the" id="jeuner" value="{{$elem->the}}" min="0" max="3"
                                        class="form-control">
                                </td>
                                <td>
                                    <textarea name="message" id="message" cols="10" rows="1"
                                        class="form-control">{{$elem->message}}</textarea>
                                </td>
                                <td class="text-center">
                                    ...
                                    <a type="submit"
                                        href="{{route('efface.choix', ['id'=>$elem->id, 'matricule'=>$elem->matricule])}}"
    ...
    <script>
        ...
        function getValue(date) {
            ...
            datePicker2.setAttribute("required", "required");
        }
